...
class InstallCommand extends Command implements PromptsForMissingInput
{
    ...
    {
        (new Filesystem)->ensureDirectoryExists(base_path('modules/auth/tests/Feature'));
        ...
        if ($this->option('pest') || $this->isUsingPest()) {
            ...
            (new Filesystem)->copyDirectory(__DIR__.'/../../stubs/'.$stubStack.'/pest-tests/Feature', base_path('modules/auth/tests/Feature'));
            (new Filesystem)->copyDirectory(__DIR__.'/../../stubs/'.$stubStack.'/pest-tests/Unit', base_path('modules/auth/tests/Unit'));
            (new Filesystem)->copy(__DIR__.'/../../stubs/'.$stubStack.'/pest-tests/Pest.php', base_path('modules/auth/tests/Pest.php'));
        } else {
            (new Filesystem)->copyDirectory(__DIR__.'/../../stubs/'.$stubStack.'/tests/Feature', base_path('modules/auth/tests/Feature'));
        }
    ...
    protected static function updateNodePackages(callable $callback, $dev = true)
    {
        ...
        $packages = json_decode(file_get_contents(base_path('modules/auth/package.json')), true);
        ...
        file_put_contents(
            base_path('modules/auth/package.json'),
    ...
    protected static function updateNodeScripts(callable $callback)
    {
        ...
        $content = json_decode(file_get_contents(base_path('modules/auth/package.json')), true);
    ...
    protected static function flushNodeModules()
    {
        tap(new Filesystem, function ($files) {
            $files->deleteDirectory(base_path('modules/auth/node_modules'));

            $files->delete(base_path('modules/auth/pnpm-lock.yaml'));
            $files->delete(base_path('modules/auth/yarn.lock'));
            $files->delete(base_path('modules/auth/bun.lock'));
            $files->delete(base_path('modules/auth/bun.lockb'));
            $files->delete(base_path('modules/auth/deno.lock'));
            $files->delete(base_path('modules/auth/package-lock.json'));
        });
    }
